package com.ayni.report_service.reports.interfaces.rest.controllers;

import com.ayni.report_service.reports.application.internal.commandServiceImpl.ReportCommandServiceImpl;
import com.ayni.report_service.reports.application.internal.queryServiceImpl.ReportQueryServiceImpl;
...
import com.ayni.report_service.reports.interfaces.rest.transform.CreateReportResourceCommandFromResourceAssembler;
import com.ayni.report_service.reports.interfaces.rest.transform.ReportResourceFromEntityAssembler;
import com.ayni.report_service.reports.interfaces.rest.transform.UpdateReportResourceCommandFromResourceAssembler;
...
public class ReportsController {
    ...
    public ResponseEntity<ReportResource> updateReport(@PathVariable Long id,
        ...
        Optional<com.ayni.report_service.reports.domain.model.aggregates.Report> updated = reportCommandService
                .handle(command);
        return updated
                .map(report -> ResponseEntity.ok(ReportResourceFromEntityAssembler.toResourceFromEntity(report)))
                .orElse(ResponseEntity.notFound().build());
